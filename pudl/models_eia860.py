...
class BoilerGeneratorAssnEIA860(models.PUDLBase):
...
class UtilityEIA860(models.PUDLBase):
...
class PlantEIA860(models.PUDLBase):
...
class OwnershipEIA860(models.PUDLBase):
...
class GeneratorEIA860(models.PUDLBase):
